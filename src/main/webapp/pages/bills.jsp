...
<style>
    ...
    @media print {
        body * {
            visibility: hidden; /* Hide everything on the page by default */
        }

        #printable-receipt, #printable-receipt * {
            visibility: visible; /* Make only the receipt and its children visible */
        }
        ...
        /* Ensure Tailwind's background/text colors don't interfere */
        ...
        @page {
            size: auto;
            margin: 20mm; /* Add some margin to the printed page */
        }
    }
</style>
